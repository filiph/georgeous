...
public class MainActivity extends Activity implements
	...
	/**
	 * The time when we showed George, or null if we didn't. The value is used
	 * to give user enough time to read what George has to say.
	 */
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		mShareActionProvider = (ShareActionProvider) mShareItem
				.getActionProvider();
	...
	private class MainActivityReceiver extends BroadcastReceiver {
		...
		private void handleFeedResultIntent(Intent intent) {
			...
			mPrefs.edit().putLong(LAST_CHECK_FINISHED_TIME, mLastCheckTime)
					.commit();
