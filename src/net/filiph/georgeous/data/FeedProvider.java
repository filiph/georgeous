...
public class FeedProvider extends ContentProvider {
	...
	private Cursor getArticles(String[] projection, String selection,
		...
		return qBuilder.query(mOpenHelper.getReadableDatabase(), 
	...
	public String getType(Uri uri) {
		Log.v(TAG, "FeedProvider's getType was called with uri " + uri.toString());
		int match = sURIMatcher.match(uri);
		switch (match) {
			case ARTICLES:
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		Log.w(TAG, "Delete is not fully implemented on the FeedProvider. It just deletes the whole thing.");
